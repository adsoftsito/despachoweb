...
var Login = (function () {
    function Login(fb, translate, router, _service) {
        ...
        this.langDefault();
        this.iconLogin = __WEBPACK_IMPORTED_MODULE_6__theme_theme_constants__["c" /* IMAGES_ROOT */] + 'logoblanco.svg';
    ...
    Login.prototype.resolved = function (captchaResponse) {
        console.log("Resolved captcha with response " + captchaResponse + ":");
    };
    Login.prototype.validateEmail = function (emailValid) {
        var _this = this;
    ...
    Login.prototype.validatePassword = function (emptypassword, passwordValidity, accountant) {
        var _this = this;
    ...
    Login.prototype.validateLoginData = function () {
        var _this = this;
    ...
    Login.prototype.statusChange = function () {
        this.isPassword = !(this.isPassword);
    };
    Login.prototype.changeLanguage = function (lang) {
        this.translate.use(lang);
        localStorage.setItem('lang', lang);
    };
    Login.prototype.langDefault = function () {
...
], Login.prototype, "popover", void 0);
Login = __decorate([
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__login_component__ = __webpack_require__(1324);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__login_component__ = __webpack_require__(1324);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__login_routing__ = __webpack_require__(1423);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_ng_recaptcha__ = __webpack_require__(1304);
